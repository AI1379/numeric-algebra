...
table_3_2_t = np.array([-1.0, -0.75, -0.5, 0.0, 0.25, 0.5, 0.75])
table_3_2_y = np.array([1.00, 0.8125, 0.75, 1.00, 1.3125, 1.75, 2.3125])

table_3_3_y = np.array([
...
table_3_4_A = np.array([
    ...
    [14.4598, 2.5, 12.8000,  3.0000,  2.0,  9,  5,  14,  4,  1,  1],
